# Runbook — sdkwork-skills deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-skills-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-skills/bundle`, loads the image, starts
