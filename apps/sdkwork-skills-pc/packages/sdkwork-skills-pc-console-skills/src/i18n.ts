...
const enUs = {
  ...
  "create.error.categoryRequired": "Select a category before creating the skill package.",
  ...
  "category.empty.description":
    "An administrator has not published any Skill category yet. Ask an administrator to create one before creating packages.",
  "category.groupLabel": "Skill category",
...
const zhCn: Record<keyof typeof enUs, string> = {
  ...
  "create.error.categoryRequired": "创建 Skill 包前，请先选择分类。",
  ...
  "category.empty.description": "管理员尚未发布任何 Skill 分类。请先请管理员创建分类，再创建 Skill 包。",
  "category.groupLabel": "Skill 分类",
